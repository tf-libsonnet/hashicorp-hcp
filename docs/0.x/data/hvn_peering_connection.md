...
**Args**:
  ...
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [hcp.data.hvn_peering_connection.timeouts.new](#fn-hvn_peering_connectiontimeoutsnew) constructor.
...
Unlike [hcp.data.hvn_peering_connection.new](#fn-hvn_peering_connectionnew), this function will not inject the `data source`
