...
**Args**:
  ...
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [hcp.data.boundary_cluster.timeouts.new](#fn-boundary_clustertimeoutsnew) constructor.
...
Unlike [hcp.data.boundary_cluster.new](#fn-boundary_clusternew), this function will not inject the `data source`
