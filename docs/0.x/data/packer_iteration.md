...
`hcp.packer_iteration.withBucketName` constructs a mixin object that can be merged into the `packer_iteration`
...
`hcp.packer_iteration.withChannel` constructs a mixin object that can be merged into the `packer_iteration`
...
`hcp.packer_iteration.withTimeouts` constructs a mixin object that can be merged into the `packer_iteration`
...
`hcp.packer_iteration.withTimeoutsMixin` constructs a mixin object that can be merged into the `packer_iteration`
Terraform data source block to set or update the timeouts field.
