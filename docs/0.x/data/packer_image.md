...
`hcp.packer_image.withBucketName` constructs a mixin object that can be merged into the `packer_image`
...
`hcp.packer_image.withChannel` constructs a mixin object that can be merged into the `packer_image`
...
`hcp.packer_image.withCloudProvider` constructs a mixin object that can be merged into the `packer_image`
...
`hcp.packer_image.withComponentType` constructs a mixin object that can be merged into the `packer_image`
...
`hcp.packer_image.withIterationId` constructs a mixin object that can be merged into the `packer_image`
...
`hcp.packer_image.withRegion` constructs a mixin object that can be merged into the `packer_image`
...
`hcp.packer_image.withTimeouts` constructs a mixin object that can be merged into the `packer_image`
...
`hcp.packer_image.withTimeoutsMixin` constructs a mixin object that can be merged into the `packer_image`
Terraform data source block to set or update the timeouts field.
