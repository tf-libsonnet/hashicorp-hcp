...
**Args**:
  ...
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [hcp.consul_cluster_root_token.timeouts.new](#fn-consul_cluster_root_tokentimeoutsnew) constructor.
...
Unlike [hcp.consul_cluster_root_token.new](#fn-consul_cluster_root_tokennew), this function will not inject the `resource`
