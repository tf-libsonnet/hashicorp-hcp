...
`hcp.aws_network_peering.withPeerAccountId` constructs a mixin object that can be merged into the `aws_network_peering`
...
`hcp.aws_network_peering.withPeerVpcId` constructs a mixin object that can be merged into the `aws_network_peering`
...
`hcp.aws_network_peering.withPeerVpcRegion` constructs a mixin object that can be merged into the `aws_network_peering`
