...
`hcp.consul_snapshot.withClusterId` constructs a mixin object that can be merged into the `consul_snapshot`
...
`hcp.consul_snapshot.withSnapshotName` constructs a mixin object that can be merged into the `consul_snapshot`
...
`hcp.consul_snapshot.withTimeouts` constructs a mixin object that can be merged into the `consul_snapshot`
...
`hcp.consul_snapshot.withTimeoutsMixin` constructs a mixin object that can be merged into the `consul_snapshot`
Terraform resource block to set or update the timeouts field.
