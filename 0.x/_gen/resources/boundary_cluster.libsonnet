...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withPassword':: d.fn(help='`hcp.boundary_cluster.withPassword` constructs a mixin object that can be merged into the `boundary_cluster`\nTerraform resource block to set or update the password field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `password` field.\n', args=[]),
  ...
  '#withUsername':: d.fn(help='`hcp.boundary_cluster.withUsername` constructs a mixin object that can be merged into the `boundary_cluster`\nTerraform resource block to set or update the username field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `username` field.\n', args=[]),
