...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withProxyEndpoint':: d.fn(help='`hcp.string.withProxyEndpoint` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the proxy_endpoint field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `proxy_endpoint` field.\n', args=[]),
  withProxyEndpoint(resourceLabel, value): {
    resource+: {
      hcp_vault_cluster+: {
        [resourceLabel]+: {
