...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withTargetLink':: d.fn(help='`hcp.hvn_route.withTargetLink` constructs a mixin object that can be merged into the `hvn_route`\nTerraform resource block to set or update the target_link field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `target_link` field.\n', args=[]),
