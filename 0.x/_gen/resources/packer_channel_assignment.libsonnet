...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  withIterationId(resourceLabel, value): {
    resource+: {
      hcp_packer_channel_assignment+: {
        [resourceLabel]+: {
          iteration_id: value,
  ...
  '#withIterationVersion':: d.fn(help='`hcp.number.withIterationVersion` constructs a mixin object that can be merged into the `number`\nTerraform resource block to set or update the iteration_version field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`number`): The value to set for the `iteration_version` field.\n', args=[]),
  withIterationVersion(resourceLabel, value): {
    resource+: {
      hcp_packer_channel_assignment+: {
        [resourceLabel]+: {
          iteration_version: value,
        },
      },
    },
  },
