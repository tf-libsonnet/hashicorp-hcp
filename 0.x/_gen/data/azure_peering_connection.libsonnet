...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withWaitForActiveState':: d.fn(help='`hcp.azure_peering_connection.withWaitForActiveState` constructs a mixin object that can be merged into the `azure_peering_connection`\nTerraform data source block to set or update the wait_for_active_state field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `wait_for_active_state` field.\n', args=[]),
