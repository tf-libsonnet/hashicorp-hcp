...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withChannel':: d.fn(help='`hcp.packer_image.withChannel` constructs a mixin object that can be merged into the `packer_image`\nTerraform data source block to set or update the channel field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `channel` field.\n', args=[]),
  ...
  '#withCloudProvider':: d.fn(help='`hcp.packer_image.withCloudProvider` constructs a mixin object that can be merged into the `packer_image`\nTerraform data source block to set or update the cloud_provider field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `cloud_provider` field.\n', args=[]),
  ...
  '#withComponentType':: d.fn(help='`hcp.packer_image.withComponentType` constructs a mixin object that can be merged into the `packer_image`\nTerraform data source block to set or update the component_type field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `component_type` field.\n', args=[]),
  ...
  '#withIterationId':: d.fn(help='`hcp.packer_image.withIterationId` constructs a mixin object that can be merged into the `packer_image`\nTerraform data source block to set or update the iteration_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `iteration_id` field.\n', args=[]),
  ...
  '#withRegion':: d.fn(help='`hcp.packer_image.withRegion` constructs a mixin object that can be merged into the `packer_image`\nTerraform data source block to set or update the region field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `region` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`hcp.packer_image.withTimeouts` constructs a mixin object that can be merged into the `packer_image`\nTerraform data source block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`hcp.packer_image.withTimeoutsMixin` constructs a mixin object that can be merged into the `packer_image`\nTerraform data source block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [hcp.packer_image.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
