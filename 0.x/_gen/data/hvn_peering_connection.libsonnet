...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withHvn1':: d.fn(help='`hcp.hvn_peering_connection.withHvn1` constructs a mixin object that can be merged into the `hvn_peering_connection`\nTerraform data source block to set or update the hvn_1 field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `hvn_1` field.\n', args=[]),
  ...
  '#withHvn2':: d.fn(help='`hcp.hvn_peering_connection.withHvn2` constructs a mixin object that can be merged into the `hvn_peering_connection`\nTerraform data source block to set or update the hvn_2 field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `hvn_2` field.\n', args=[]),
  ...
  '#withPeeringId':: d.fn(help='`hcp.hvn_peering_connection.withPeeringId` constructs a mixin object that can be merged into the `hvn_peering_connection`\nTerraform data source block to set or update the peering_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `peering_id` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`hcp.hvn_peering_connection.withTimeouts` constructs a mixin object that can be merged into the `hvn_peering_connection`\nTerraform data source block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`hcp.hvn_peering_connection.withTimeoutsMixin` constructs a mixin object that can be merged into the `hvn_peering_connection`\nTerraform data source block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [hcp.hvn_peering_connection.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
