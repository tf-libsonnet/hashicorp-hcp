...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withBucketName':: d.fn(help='`hcp.packer_iteration.withBucketName` constructs a mixin object that can be merged into the `packer_iteration`\nTerraform data source block to set or update the bucket_name field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `bucket_name` field.\n', args=[]),
  ...
  '#withChannel':: d.fn(help='`hcp.packer_iteration.withChannel` constructs a mixin object that can be merged into the `packer_iteration`\nTerraform data source block to set or update the channel field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `channel` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`hcp.packer_iteration.withTimeouts` constructs a mixin object that can be merged into the `packer_iteration`\nTerraform data source block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`hcp.packer_iteration.withTimeoutsMixin` constructs a mixin object that can be merged into the `packer_iteration`\nTerraform data source block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [hcp.packer_iteration.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
