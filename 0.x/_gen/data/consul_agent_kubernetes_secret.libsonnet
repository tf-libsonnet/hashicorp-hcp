...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withClusterId':: d.fn(help='`hcp.consul_agent_kubernetes_secret.withClusterId` constructs a mixin object that can be merged into the `consul_agent_kubernetes_secret`\nTerraform data source block to set or update the cluster_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `cluster_id` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`hcp.consul_agent_kubernetes_secret.withTimeouts` constructs a mixin object that can be merged into the `consul_agent_kubernetes_secret`\nTerraform data source block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`hcp.consul_agent_kubernetes_secret.withTimeoutsMixin` constructs a mixin object that can be merged into the `consul_agent_kubernetes_secret`\nTerraform data source block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [hcp.consul_agent_kubernetes_secret.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
