...
{
  '#':: d.pkg(name='consul_agent_helm_config', url='', help='`consul_agent_helm_config` represents the `hcp_consul_agent_helm_config` Terraform data source.\n\nThe Consul agent Helm config data source provides Helm values for a Consul agent running in Kubernetes.\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withClusterId':: d.fn(help='`hcp.consul_agent_helm_config.withClusterId` constructs a mixin object that can be merged into the `consul_agent_helm_config`\nTerraform data source block to set or update the cluster_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `cluster_id` field.\n', args=[]),
  ...
  '#withExposeGossipPorts':: d.fn(help='`hcp.consul_agent_helm_config.withExposeGossipPorts` constructs a mixin object that can be merged into the `consul_agent_helm_config`\nTerraform data source block to set or update the expose_gossip_ports field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `expose_gossip_ports` field.\n', args=[]),
  ...
  '#withKubernetesEndpoint':: d.fn(help='`hcp.consul_agent_helm_config.withKubernetesEndpoint` constructs a mixin object that can be merged into the `consul_agent_helm_config`\nTerraform data source block to set or update the kubernetes_endpoint field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `kubernetes_endpoint` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`hcp.consul_agent_helm_config.withTimeouts` constructs a mixin object that can be merged into the `consul_agent_helm_config`\nTerraform data source block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`hcp.consul_agent_helm_config.withTimeoutsMixin` constructs a mixin object that can be merged into the `consul_agent_helm_config`\nTerraform data source block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [hcp.consul_agent_helm_config.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
